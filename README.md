...
## Key Features
* Includes a 2% "Black Swan" probability where the market can crash.
* Uses the "Square Root of Time" rule to convert annual volatility (28%) into daily fluctuations.
